"""
Performance tests for resource management in AutoCSV Profiler.
...
from tests.utils.test_helpers import MemoryTracker, clean_test_outputs, create_test_csv
...
class TestResourceManagement:
    ...
    def test_memory_usage_small_file(self, temp_workspace, memory_tracker):
        ...
        try:
            from autocsv_profiler.analyzer import main
    ...
    def _mock_memory_usage_test(self, csv_file, memory_tracker, expected_max_mb):
        ...
        if memory_info["peak"]:
            assert (
                memory_info["peak"] < expected_max_mb + 200
            )  # Allow overhead for mock
