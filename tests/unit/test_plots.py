...
from tests.fixtures.sample_data import (
    ...
    generate_dirty_sample_data,
    generate_high_cardinality_data,
)
from tests.utils.test_helpers import clean_test_outputs
...
class TestVisualizationSystemCore:
    ...
    def test_visualization_worker_basic_execution(
        self, mock_figure, mock_savefig, temp_output_dir, sample_data
    ):
...
class TestVisualizationTypes:
    ...
    @patch("matplotlib.pyplot.savefig")
    def test_numerical_visualizations(
        self, mock_savefig, mock_show, numerical_data, temp_output_dir
    ):
    ...
    def test_categorical_visualizations(
        self, mock_savefig, mock_show, categorical_data, temp_output_dir
    ):
